    ...
    public function getLocaleErrorMapping($errorIdentifier)
    {
        switch ($errorIdentifier) {
            ...
            case 'SKRILL_ERROR_99_GENERAL':
                ...
                break;
            case 'ERROR_INVLAID_CITY_NAME':
                if ($this->l('ERROR_INVLAID_CITY_NAME') == "ERROR_INVLAID_CITY_NAME") {
                    $returnMessage = "Invalid city name format";
                } else {
                    $returnMessage = $this->l('ERROR_INVLAID_CITY_NAME');
                }
                break;
            default:
