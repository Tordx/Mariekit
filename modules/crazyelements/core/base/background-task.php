...
include_once CRAZY_PATH . '/includes/libraries/wp-background-process/wp-async-request.php';
include_once CRAZY_PATH . '/includes/libraries/wp-background-process/wp-background-process.php';
...
abstract class Background_Task extends \WP_Background_Process {
	...
	public function dispatch() {
		...
		if ( PrestaHelper::is_wp_error( $dispatched ) ) {
			wp_die( $dispatched );
		}
	}
	...
	public function continue_run() {
		...
		PrestaHelper::do_action( $this->cron_hook_identifier );
	}
