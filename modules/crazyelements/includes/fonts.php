...
class Fonts {
	...
	public static function get_font_groups() {
		if ( null === self::$font_groups ) {
			$font_groups = [
				self::SYSTEM => PrestaHelper::__( 'System', 'elementor' ),
				self::GOOGLE => PrestaHelper::__( 'Google', 'elementor' ),
				self::EARLYACCESS => PrestaHelper::__( 'Google Early Access', 'elementor' ),
			];
			$font_groups = PrestaHelper::apply_filters( 'elementor/fonts/groups', $font_groups );
	...
	public static function get_fonts() {
		if ( null === self::$fonts ) {
			$additional_fonts = [];
			$additional_fonts = PrestaHelper::apply_filters( 'elementor/fonts/additional_fonts', $additional_fonts );
