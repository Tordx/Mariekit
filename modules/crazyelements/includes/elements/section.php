...
class Element_Section extends Element_Base {
	...
	protected function _content_template() {
		?>
<# if ( settings.background_video_link ) { let videoAttributes='autoplay muted playsinline' ; if ( !
    settings.background_play_once ) { videoAttributes +=' loop' ; } #>
        ...
        <<?php echo PrestaHelper::esc_html( $this->get_html_tag() ); ?>
            ...
            <div class="elementor-background-video-container elementor-hidden-phone">
                ...
                <video class="elementor-background-video-hosted elementor-html5-video"
                    <?php echo $video_tag_attributes; ?>></video>
                <?php endif; ?>
            </div>
            <?php
				endif;
            ...
            <div
                class="elementor-container elementor-column-gap-<?php echo PrestaHelper::esc_attr( $settings['gap'] ); ?>">
	...
	private function print_shape_divider( $side ) {
		...
		?>
        <div class="elementor-shape elementor-shape-<?php echo PrestaHelper::esc_attr( $side ); ?>"
