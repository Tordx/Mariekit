...
class Group_Control_Text_Stroke extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$controls['text_stroke'] = [
			'label' => PrestaHelper::_x( 'Text Stroke', 'elementor' ),
		...
		$controls['stroke_color'] = [
			'label' => PrestaHelper::_x( 'Stroke Color', 'elementor' ),
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => PrestaHelper::_x( 'Text Stroke', 'Text Stroke Control', 'elementor' ),
