...
class Controls_Manager {
	...
	public function add_custom_css_controls( Controls_Stack $controls_stack ) {
		...
		$controls_stack->start_controls_section(
			...
			array(
				'label' => PrestaHelper::__( 'Custom CSS (PRO)', 'elementor' ),
		...
		$controls_stack->add_control(
			...
			array(
				'type'            => self::RAW_HTML,
				'raw'             => PrestaHelper::__( '<a href="https://classydevs.com/prestashop-page-builder/pricing/?utm_source=crazyfree&utm_medium=crazyfree_module&utm_campaign=crazyfree&utm_term=crazyfree&utm_content=crazyfree" target="_blank">Click Here and Get PRO</a> To Use This Feature.', 'elementor' ),
				'type'            => self::RAW_HTML,
