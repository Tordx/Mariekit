...
class Widget_Social_Icons extends Widget_Base {
	...
	public function get_title() {
		return PrestaHelper::__( 'Social Icons', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_social_icon',
			[
				'label' => PrestaHelper::__( 'Social Icons', 'elementor' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => PrestaHelper::__( 'Official Color', 'elementor' ),
		...
		$icon_spacing = PrestaHelper::is_rtl() ? 'margin-left: {{SIZE}}{{UNIT}};' : 'margin-right: {{SIZE}}{{UNIT}};';
		...
		$this->start_controls_section(
			...
			[
				'label' => PrestaHelper::__( 'Icon Hover', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
			...
			foreach ( $settings['social_icon_list'] as $index => $item ) {
				...
				<a <?php echo $this->get_render_attribute_string( $link_key ); ?>>
					...
					if ( $is_new || $migrated ) {
						...
						<i class="<?php echo PrestaHelper::esc_attr( $item['social'] ); ?>"></i>
					<?php } ?>
				</a>
			<?php } ?>
		</div>
