	...
	$.widget( 'wp.wpColorPicker', $.wp.wpColorPicker, {
		...
		_create: function() {
			...
			var setTogglerColor = function( color ) {
				...
				if ( self.options.alpha ) {
					...
					self.toggler.find( 'span.color-alpha' ).css( { backgroundColor : color.toString()} );
				} else {
		...
		_addListeners: function() {
			...
			self.toggler.click( function(){
				...
				if(preself!=self){
					if ( preself.toggler.hasClass( 'wp-picker-open' ) ) {
						preself.close();
					}
					preself=self
				}
	...
	$.widget( 'a8c.iris', $.a8c.iris, {
		...
		_change: function() {
			...
			if ( self.options.alpha ) {
				...
				// var color1 = this._color.toRgb(),
				// var gradient1 = [
				// 	'rgb(' + color1.r + ',' + color1.g + ',' + color1.b + ') 0%',
				// 	'rgba(' + color1.r + ',' + color1.g + ',' + color1.b + ', 0) 100%'
				// ];
				// $(this).find( 'span.color-alpha' ).css( 'backgroundColor', gradient1.join( ', ' ) );
