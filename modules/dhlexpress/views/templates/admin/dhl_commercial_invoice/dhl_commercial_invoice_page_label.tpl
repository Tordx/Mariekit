        ...
        <div class="col-lg-12">
          <div class="panel form-horizontal clearfix">
            <div class="panel-heading">
              <i class="icon-user"></i>
              {l s='Send edatats' mod='dhlexpress'}
            </div>
            <div class="alert alert-info js-message-data-edata" style="display: none">
              {l s='Please verify that the data in your invoice match the ones you are sending to DHL' mod='dhlexpress'}
            </div>
           ...
           {* <div class="dhl-process-button">
              <button id="submit-dhl-invoice-download" type="submit" class="btn btn-primary"
                ...
                <i class="process-icon- icon-file-text"></i> {l s='Send edatas' mod='dhlexpress'}
              </button>
            </div>*}
