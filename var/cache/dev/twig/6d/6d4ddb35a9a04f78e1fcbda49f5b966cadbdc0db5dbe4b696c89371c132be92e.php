...
class __TwigTemplate_ff89af6b483471335723d7e2899b6638517ca2801e9328c94ac630225d6765f7 extends \Twig\Template
{
...
($context["module"] ?? $this->getContext($context, "module")), "attributes", []), "url_active", []) != "buy")) {
    ...
    ";
        // line 118
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/modal_read_more.html.twig", "@PrestaShop/Admin/Module/Includes/card_grid.html.twig", 118)->display(twig_array_merge($context, ["module" => ($context["module"] ?? $this->getContext($context, "module")), "additionalModalSuffix" => ((array_key_exists("additionalModalSuffix", $context)) ? (_twig_default_filter(($context["additionalModalSuffix"] ?? $this->getContext($context, "additionalModalSuffix")), "")) : ("")), "level" => ($context["level"] ?? $this->getContext($context, "level"))]));
        // line 119
        echo "    ";
...
", "@PrestaShop/Admin/Module/Includes/card_grid.html.twig", "C:\\xampp\\htdocs\\prestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\card_grid.html.twig");
    }
}
