...
$catalogue = new MessageCatalogue('fr-CA', array (
  ...
  array (
    ...
    'Sample Store Contacts file' => 'Exemple de fichier avec contacts de boutiques',
    ...
    'Unit Price (tax excl.)*' => 'Prix unitaire (avant taxe)*',
    ...
    'This is a test message. Your server is now configured to send email.' => 'Ceci est un mail essai, votre serveur est prêt pour envoyer des courriels.',
    ...
    'Never send emails (may be useful for testing purposes)' => 'Ne jamais envoyer de courriels (utile en phase de test)',
    ...
    'Label when backorder allowed' => 'Étiquette en cas de commande en attente',
    ...
    'Maximum size for attached files' => 'Taille maximale des fichiers attachés',
    ...
    'Multi-front optimizations' => 'Optimisations multi-serveurs',
    ...
    'Both' => 'Les deux',
    'Send email in HTML format' => 'Envoyer les courriels au format HTML',
    'Send email in text format' => 'Envoyer le courriel au format texte',
    'Send emails to' => 'Envoyer les e-mails à',
    'Log Emails' => 'Loguer les courriels envoyés',
    'None' => 'Aucun',
    'TLS' => 'TLS',
    'SSL' => 'SSL',
    ...
    'Send a test email to' => 'Envoyer un courriel test à',
    'minutes' => 'minutes',
    ...
    'Mail domain name' => 'Nom de domaine des courriels',
    'Port number to use.' => 'Numéro du port à utiliser.',
    'Test your email configuration' => 'Essai de votre configuration courriel',
    ...
    'Logs by email' => 'Alertes par courriel',
    'Profile' => 'Profil',
    ...
    'Price tax excluded' => 'Prix sans taxe',
    'Price tax included' => 'Prix avec taxe',
  ...
  array (
    ...
    'Allow or disallow this employee to log in to the Admin panel.' => 'Autoriser ou interdire à cet employé de se connecter au back-office.',
    ...
    'Enter "5" if you do not want to receive any emails.' => 'Mettre "5" si vous ne souhaitez pas recevoir d\'alertes par courriel.',
    'Emails will be sent to the shop owner.' => 'Les courriels seront destinés au propriétaire de la boutique.',
  ...
  array (
    ...
    'Error - The following e-mail template is missing: %s' => 'Erreur - Le template de courriel suivant n\'existe pas: %s',
    ...
    'Supplier ID (%id%) is not valid (at line %line%).' => 'L\'ID du fournisseur (%id%) n\'est pas valable (ligne %line%).',
    'Lang ID (%id%) is not valid (at line %line%).' => 'L\'ID de la langue (%id%) n\'est pas valable (à la ligne %line%).',
    'Warehouse ID (%id%) is not valid (at line %line%).' => 'L\'ID de l\'entrepôt (%id%) n\'est pas valable (ligne %line%).',
    'Currency ID (%id%) is not valid (at line %line%).' => 'L\'ID la devise (%id%) n\'est pas valable (ligne %line%).',
    ...
    'Discount rate (%rate%) is not valid (at line %line%). %format%.' => 'Le taux de réduction (%rate%) n\'est pas valable (ligne %line%). %format%.',
    'Supply Order (%id%) is not editable (at line %line%).' => 'La commande fournisseur (%id%) n\'est pas modifiable (ligne %line%).',
    ...
    'Unit Price (tax excl.) (%d) is not valid (at line %d).' => 'Le prix unitaire (avant taxe) (%d) n\'est pas valable (ligne %d).',
    ...
    'The file is too large and cannot be downloaded. Please use the LIMIT clause in this query.' => 'Le fichier est trop volumineux et ne peut pas être téléchargé. Veuillez utiliser la clause LIMIT dans cette requête.',
    ...
    'The category ID must be unique. It can\'t be the same as the one for Root or Home category.' => 'L\'identifiant de la catégorie doit être unique. Il ne peut être le même que celui des catégories Racine ou Accueil.',
    'The category ID must be unique. It can\'t be the same as the one for the parent category (ID: %1$s).' => 'L\'identifiant de la catégorie doit être unique. Il ne peut pas être le même que celui d\'une catégorie parente (ID: %1$s).',
    ...
    'URL rewriting failed to auto-generate a friendly URL for: %category_name%' => 'La réécriture d\'URL automatique n\'est pas parvenue à générer une URL simplifiée et pour : %category_name%',
  ...
  array (
    ...
    'Transfer from another warehouse' => 'Transfert d\'un autre entrepôt',
    ...
    'Pre-tax retail price' => 'Prix de vente avant taxe',
    'Retail price with tax' => 'Prix de vente avec taxes',
    ...
    'No tax' => 'Aucune taxe',
    'Ecotax (tax incl.)' => 'Écotaxe (avec taxes)',
    ...
    'Target category' => 'Catégorie de destination',
    'Target' => 'Destination',
    ...
    'Edit: %value%' => 'Modification : %value%',
    'Price (tax incl.)' => 'Montant (avec taxes)',
    'Category' => 'Catégorie',
    'Price (tax excl.)' => 'Montant (avant taxe)',
    ...
    'Search Engine Optimization' => 'Optimisation pour les moteurs de recherche (SEO)',
    ...
    '%group_name% - All people without a valid customer account.' => '%group_name% - Toutes les personnes sans compte client ou non connectées.',
  ...
  array (
    ...
    'You can choose a minimum amount for the cart either with or without the taxes and shipping.' => 'Vous pouvez choisir le montant minimum du panier avec ou sans la taxe et les frais de transport.',
    ...
    'Create new threads for unrecognized emails.' => 'Créer de nouveaux sujets pour les courriels non reconnus.',
    ...
    'Combine several attributes, e.g.: "Size: all", "Color: red".' => 'Combiner plusieurs attributs, par ex. « Taille : tous », « Couleur : rouge ».',
    'Leave empty to disable' => 'Laisser vide pour désactiver',
    ...
    'Where should the product be available on your site? The main category is where the product appears by default: this is the category which is seen in the product page\'s URL. Disabled categories are written in italics.' => 'Où le produit doit-il être visible sur votre site ? La catégorie principale est là où le produit apparaîtra par défaut : c\'est la catégorie qui apparaîtra dans l\'URL de la fiche produit. Les catégories non actives sont en italique.',
    ...
    'Does this combination have a different price? Is it cheaper or more expensive than the default retail price?' => 'Cette combinaison a-t-elle un prix différent ? Est-elle plus ou moins chère que le prix de vente par défaut ?',
    ...
    'Advanced settings in [1][2]Combinations[/1]' => 'Paramètres avancés dans [1][2]Combinaisons[/1]',
  ...
  array (
    ...
    'A virtual product can\'t have combinations.' => 'Un produit virtuel ne peut pas avoir de combinaisons.',
  ...
  array (
    ...
    'Invoice & Email Logos' => 'Logos pour les factures et les courriels',
    'Favicons' => 'Favicons',
  ...
  array (
    ...
    'Will appear on email headers. If undefined, the header logo will be used.' => 'Apparaîtra dans l\'en-tête des courriels ; s\'il n\'est pas défini, le logo de l\'en-tête sera utilisé.',
...
Once you enable the "%generate_rtl_label%" option, any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.' => 'Attention ! Veuillez vérifier que votre thème est dans une langue RTL avant de générer une feuille de style RTL : votre thème pourrait déjà être compatible RTL. En cliquant sur "%generate_rtl_label%", n\'importe quel fichier spécifique au RTL que vous auriez ajouté à votre thème pourrait être supprimé par la feuille de style créée.',
  ...
  array (
    ...
    'Current theme is unavailable. Please check your theme\'s directory name ("%s") and permissions.' => 'Le thème actuel n\'est pas disponible. Merci de vérifier le répertoire de votre thème ("%s") et ses permissions.',
    ...
    'Cannot write images for this type: %1$s. Please check the %2$s folder\'s writing permissions.' => 'Impossible d\'écrire les images pour le type « %1$s ». Veuillez vérifier les droits d\'écriture du dossier « %2$s ».',
    ...
    'Warning: if no email logo is available, the main logo will be used instead.' => 'Attention: si aucun logo de courriel n\'est défini, le logo de l\'en-tête est utilisé à la place.',
  ),
  'AdminGlobal' => 
  array (
    'None' => 'Aucun',
    ...
    'Shop group' => 'Groupe de boutiques',
    'Module' => 'Module',
    'Bug Tracker' => 'Outil de suivi des bugs',
    'Messages' => 'Messages',
    'ID' => 'ID',
    'No' => 'Non',
    'Yes' => 'Oui',
  ...
  array (
    ...
    'Up' => 'Monter',
    'missing' => 'manquantes',
    'Core emails' => 'Courriels du coeur',
    'Module emails' => 'Courriels des modules',
    ...
    'Display tax label (e.g. "Tax incl.")' => 'Afficher le label de la taxe (ex. : "TPS")',
    'Does it need Zip/Postal code?' => 'Requiert un code postal?',
    'Zip/Postal code format' => 'Format du code postal',
    ...
    'Themes translations' => 'Traductions des thèmes',
    'Live exchange Rate for %shop_name%' => 'Taux de change en direct pour %shop_name%',
  ...
  array (
    ...
    'Two -- or three -- letter ISO code (e.g. "us" for United States).' => 'Code ISO à deux ou trois lettres (ex. : "ca" pour le Canada).',
    ...
    'Tax name to display in carts and on invoices (e.g. "VAT").' => 'Nom de la taxe à afficher dans le panier et sur la facture (ex. : "TPS").',
  ...
  array (
    ...
    'Impossible to create the directory "%folder%".' => 'Impossible de créer le repertoire "%folder%".',
    ...
    'Your HTML email templates cannot contain JavaScript code.' => 'Les modèles HTML des courriels ne peuvent pas contenir du code JavaScript.',
    ...
    'Cannot write language file for email subjects. Path is: %folder%' => 'Impossible d\'écrire dans le fichier de langue pour les sujets des courriels : "%folder%"',
  ...
  array (
    ...
    'Please, check your mailbox.' => 'Veuillez consulter votre boîte de courriels.',
  ...
  array (
    ...
    'Merchandising' => 'Commerce de marchandise',
    ...
    'Emailing & SMS' => 'Envoi de courriels et SMS',
    ...
    'See all results for your search on' => 'Voir tous les résultats de votre recherche sur',
    'Read More' => 'En savoir plus',
  ...
  array (
    ...
    'Failed to install admin tab "%name%".' => 'Impossible d\'installer l\'onglet admin "%name%".',
    'Failed to uninstall admin tab "%name%".' => 'Impossible de désinstaller l\'onglet admin "%name%".',
...
',
    ...
    'If it\'s a URL that comes from your back office, you MUST remove the security token.' => 'Si c\'est une URL qui vient de votre back-office, vous DEVEZ supprimer le jeton de sécurité.',
  ...
  array (
    ...
    'Your entry in field %1$s (language %2$s) exceeds max length %3$d chars (incl. html tags).' => 'Le champs %1$s (langue %2$s) dépasse la longueur max. autorisée (%3$d caractères, y compris les tags html).',
    ...
    'File is too big. Current size is %1s, maximum size is %2s.' => 'Le fichier est trop volumineux. Sa taille actuelle est %1s, la taille maximum possible est %2s.',
    ...
    'Email is empty.' => 'Adresse courriel manquante.',
    ...
    'Error while updating the status.' => 'Erreur lors de la mise à jour du statut.',
    ...
    'A Zip/Postal code is required.' => 'Le code postal est requis.',
    'The Zip/Postal code is invalid.' => 'Le code postal est invalide.',
    'You do not have permission to upload this.' => 'Vous n\'avez pas la permission d\'envoyer ça.',
    ...
    'Invalid tag(s) (%s)' => 'Mots-clé(s) invalides (%s)',
    ...
    'The email address is invalid.' => 'Courriel non valide.',
...
',
  ...
  array (
    ...
    'Text #' => 'Texte #',
    'Total cost of products:' => 'Cout total des produits :',
...
Cordialement,',
    ...
    'Return completed' => 'Retour complété',
    ...
    '5 - Order received completely' => '5 - Commande reçue complètement',
    ...
    'Credit card slip for order #%d' => 'Note de crédit concernant la commande n°%d',
    ...
    'Credit slip for order #%d' => 'Note de crédit concernant la commande n°%d',
    'Download credit slip' => 'Télécharger la note de crédit',
    ...
    'Generate a credit slip' => 'Générer une note de crédit',
    ...
    'Credit slip prefix' => 'Préfixe des notes de crédit',
    ...
    'Last emails' => 'Derniers courriels',
    ...
    'Information about customer %name%' => 'Informations du client %name%',
    ...
    'Credit slip options' => 'Configuration des notes de crédit',
  ...
  array (
    ...
    'This feature will generate a random password and send an email to the customer.' => 'Cette fonctionnalité va générer un mot de passe aléatoire et envoyer un courriel au client.',
    ...
    'This customer will receive your newsletter via email.' => 'Ce client recevra votre newsletter par courriel.',
    'Password should be at least %length% characters long.' => 'Le mot de passe doit comporter au moins %length% caractères.',
    'Enable or disable customer login.' => 'Autoriser ou non ce client à se connecter.',
    'This customer will receive your ads via email.' => 'Ce client recevra vos publicités par courriel.',
    ...
    'Prefix used for credit slips.' => 'Ce préfixe sera utilisé devant les numéros de notes de crédit.',
    'The national ID card number of this person, or a unique tax identification number.' => 'Le numéro de carte nationale d\'identité de cette personne, ou un numéro d\'identification fiscale.',
    ...
    'This feature generates a random password before sending an email to your customer.' => 'Cette fonction génère un mot de passe aléatoire et envoie un courriel au client.',
    ...
    'Send an email to the customer with the link to process the payment.' => 'Envoyer un courriel au client contenant le lien pour effectuer le paiement.',
  ...
  array (
    ...
    'A registered customer account has already claimed this email address' => 'Un compte client utilisant cette adresse courriel existe déjà',
    ...
    'This email address is not valid. Please use an address like bob@example.com.' => 'Cette adresse courriel n\'est pas valide. Une adresse valide est du type jean@exemple.com.',
    ...
    'An error occurred while changing order status, or we were unable to send an email to the customer.' => 'Une erreur est survenue lors du changement de statut et/ou de l\'envoi du courriel au client.',
    ...
    'You cannot generate a partial credit slip.' => 'Impossible de générer une note de crédit partielle.',
    ...
    'A credit slip cannot be generated.' => 'Impossible de générer une note de crédit.',
    ...
    'Error in sending the email to your customer.' => 'Erreur durant l\'envoi du courriel au client.',
    ...
    'I want my customers to be able to register again with the same email address. All data will be removed from the database.' => 'Je souhaite que mes clients puissent se recréer un compte plus tard avec la même adresse courriel: supprimer de la base de données toutes les données relatives aux clients sélectionnés.',
    ...
    'An account already exists for this email address:' => 'Un compte existe déjà avec cette adresse courriel:',
    'This email address is not registered.' => 'Adresse courriel introuvable.',
    ...
    'An error occurred while sending an email to the customer.' => 'Une erreur est survenue lors de l\'envoi du courriel au client.',
    ...
    'The email was sent to your customer.' => 'Le courriel a été envoyé au client.',
    ...
    'A registered customer account using the defined email address already exists. ' => 'Un compte client existe déjà avec la même adresse courriel. ',
    ...
    'The prices are without taxes.' => 'Les prix sont avant taxe.',
  ...
  array (
    ...
    'Please mark each checkbox for the customer group(s), for which you want the payment module(s) to be available.' => 'Veuillez cocher la case du ou de(s) groupe(s) pour lesquels vous voulez rendre disponible(s) le(s) module(s) de paiement.',
  ...
  array (
    ...
    'Free shipping' => 'Frais de port offerts',
    'Pick up in-store' => 'Ramasser en magasin',
  ...
  array (
    ...
    'Exclude taxes in sales total?' => 'Enlever les taxes du total des ventes ?',
    'Exclude shipping in sales total?' => 'Enlever les frais de transport du total des ventes ?',
    'Statistics' => 'Statistiques',
...
Thanks for your patience.' => 'Notre boutique est en cours de mise à jour, nous revenons rapidement ! Merci pour votre patience.',
    ...
    'Displayed in emails and page titles.' => 'Affiché dans les en-têtes des pages et des courriels.',
    'Shop email' => 'Adresse courriel de la boutique',
    ...
    'Send email to customer' => 'Envoyer un courriel au client',
    'Alias' => 'Alias',
    'Search' => 'Rechercher',
    ...
    'Send an email after registration' => 'Envoyer un courriel après la création du compte',
    ...
    'Display best sellers' => 'Afficher les meilleurs vendeurs',
    ...
    'Send an email to the customer when his/her order status has changed.' => 'Envoyer un courriel au client lorsque la commande est changé à cet état.',
    ...
    'Contacts' => 'Contacts',
    'Disable Reordering Option' => 'Désactiver l\'option "re-commander"',
  ...
  array (
    ...
    '%group_name% - All persons who placed an order through Guest Checkout.' => '%group_name% - Toutes les personnes qui ont passé une commande à l\'aide de la commande express (guest checkout).',
    '%group_name% - All persons who created an account on this site.' => '%group_name% - Toutes les personnes ayant créé un compte sur le site.',
    ...
    'Displayed in emails sent to customers.' => 'Affichée dans les courriels envoyés aux clients.',
    ...
    'Emails will be sent to this address.' => 'Le courriel sera envoyé à cette adresse.',
    ...
    'Disable the option to allow customers to reorder in one click from the order history page (required in some European countries).' => 'Désactiver l\'option permettant aux clients de re-commander un produit en un clic depuis la page d\'historique des commandes (requis dans certains pays européens).',
    ...
    'Email template for both .html and .txt.' => 'Modèle de courriel pour HTML et texte brut.',
  ...
  array (
    ...
    'Gross margin expressed in percentage assesses how cost-effectively you sell your goods. Out of $100, you will retain $%value% to cover profit and expenses.' => 'Le taux de marge permet d\'évaluer la rentabilité de la vente d\'un produit. Pour 100$, vous garderez %value%$ pour couvrir vos dépenses et votre bénéfice.',
    ...
    'Within your catalog, %value% of your products have had sales in the last 30 days' => 'Parmi votre catalogue, %value% de vos produits ont été vendus dans les 30 derniers jours',
  ),
  ...
  array (
    ...
    'Customer e-mail address:' => 'Adresse courriel du client:',
    'Order ID:' => 'Commande # :',
    ...
    'Import complete' => 'Import complète',
    '{followup}' => '{followup}',
    ...
    'Total Tax paid' => 'Total des taxes',
    ...
    'We have generated a credit slip in your name for order with the reference <span><strong>{order_name}</strong></span>.' => 'Nous vous informons de la génération d\'une note de crédit à votre nom relative à votre commande ayant pour référence <span><strong>{order_name}</strong></span>.',
    ...
    'This is a <strong>test e-mail</strong> from your shop.<br /><br /> If you can read this, the test was successful!' => 'Voici un <strong>courriel</strong> de test de votre boutique. <BR/><BR/>Si vous parvenez à lire ceci, le test a réussi!',
    ...
    'It&#039;s very easy to sign up. Just click here!' => 'Pour nous rejoindre, rien de plus simple, cliquez-ici !',
    'When signing up, don&#039;t forget to provide the e-mail address of your referring friend:' => 'N\'oubliez pas d\'y préciser le courriel de votre ami en tant que parrain lors de votre inscription:',
  ),
  'EmailsSubject' => 
  array (
    ...
    'Newsletter voucher' => 'Bon de réduction newsletter',
    'Newsletter confirmation' => 'Confirmation newsletter',
    'Email verification' => 'Courriel de vérification',
    ...
    'New credit slip regarding your order' => 'Nouvelle note de crédit concernant votre commande',
    'New voucher for your order #%s' => 'Nouveau bon de réduction pour votre commande %s',
  ),
  'GlobalActions' => 
  array (
  ...
  array (
    ...
    'Fileinfo extension is not enabled' => 'L\'extension Mbstring n\'est pas activée',
    ...
    'Fixtures class "%class%" not found' => 'La classe "%class%" pour les fixtures n\'a pas été trouvée',
  ...
  array (
    ...
    'If you customized the default PrestaShop e-mail templates, enabling this option will keep your modifications.' => 'Si vous avez personnalisé les modèles des emails PrestaShop par défaut, activer cette option vous fera garder vos modifications.',
  ...
  array (
    'Top-sellers block' => 'Bloc meilleurs vendeurs',
    'Adds a block displaying your store\'s top-selling products.' => 'Ajoute un bloc qui affiche les meilleurs vendeurs de la boutique.',
  ...
  array (
    ...
    'All best sellers' => 'Tous les meilleurs vendeurs',
  ),
  ...
  array (
    ...
    'Add to wishlist' => 'Ajouter à ma liste de cadeaux',
  ...
  array (
    'Shipping Estimate' => 'Estimation des livraisons',
  ...
  array (
    ...
    'An email has been sent to you with this information.' => 'Un courriel contenant ces informations vous a été envoyé.',
...
personnalisé sur votre page d’accueil.',
  ...
  array (
    ...
    'Number of "Best Sellers" to display' => 'Nombre de "Meilleurs vendeurs" à afficher',
  ...
  array (
    ...
    'Net Profit' => 'Bénéfice net',
    'Dashboard' => 'Tableau de bord',
    'Sum of revenue (excl. tax) generated within the date range by orders considered validated.' => 'Chiffre d\'affaires (avant taxe) généré sur la période donnée par les commandes considérées comme validées.',
  ...
  array (
    ...
    'Cannot update settings' => 'Impossible de mettre à jour les paramètres',
  ...
  array (
    ...
    'Would you like to send a verification email after subscription?' => 'Envoyer un courriel de vérification après inscription?',
    'Would you like to send a confirmation email after subscription?' => 'Envoyer un courriel de confirmation après inscription?',
    ...
    'Newsletter subscribers' => 'Inscrits lettre d\'info.',
    ...
    'Email address to search' => 'Adresse courriel à rechercher',
  ...
  array (
    ...
    'This email address is already registered.' => 'Adresse courriel déjà inscrite.',
    'An error occurred during the subscription process.' => 'Une erreur est survenue lors de votre inscription',
    'A verification email has been sent. Please check your inbox.' => 'Un courriel de vérification a été envoyé. Veuillez l\'ouvrir.',
    'You have successfully subscribed to this newsletter.' => 'Votre inscription a bien été prise en compte',
    'This email is already registered and/or invalid.' => 'Courriel déjà enregistré ou non valable.',
    'Thank you for subscribing to our newsletter.' => 'Merci de vous être inscrit à notre newsletter.',
  ...
  array (
    ...
    'Use tax to filter price' => 'Appliquer les filtres sur les prix avec taxes et non avant taxe',
  ...
  array (
    ...
    'Features' => 'Caractéristiques',
    'Enable \'Reordering\' feature' => 'Activer l\'option "Re-commander"',
...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    'Your e-mail address is invalid' => 'Votre adresse courriel est invalide',
  ...
  array (
    ...
    'Newsletter subscribers' => 'Inscrits lettre d\'info.',
    'Filter newsletter subscribers.' => 'Opérer un filtre sur les inscrits à la lettre d\'information.',
    'All customers' => 'Tous les clients',
    'Subscribers' => 'Inscrits',
    'Non-subscribers' => 'Non-inscrits',
    'Opt-in subscribers' => 'Abonnés aux partenaires',
    'Filter opt-in subscribers.' => 'Filtre les inscrits aux messages partenaires.',
    'No customers found with these filters!' => 'Aucun client trouvé avec ces paramètres',
    'The .CSV file has been successfully exported: %d customers found.' => 'Le fichier .CSV a bien été exporté : %d clients trouvés.',
    'Download the file' => 'Télécharger le fichier',
    'WARNING: When opening this .csv file with Excel, choose UTF-8 encoding to avoid strange characters.' => 'ATTENTION : Lorsque vous ouvrez ce fichier .csv avec Excel, choisissez bien l\'encodage UTF-8 pour éviter les caractères anormaux.',
  ...
  array (
    ...
    'day(s)' => 'jour(s)',
    'The next process will send %d e-mail(s).' => 'Le prochain processus enverra %d courriel(s).',
    ...
    'Next process will send: %d e-mail(s)' => 'Le prochain envoi transmettra : %d courriel(s)',
    ...
    'Sent = Number of sent e-mails' => 'Envoyés : nombre de courriel envoyés',
...
suivre pour développer votre communauté.',
  ...
  array (
    'Specials block' => 'Bloc des spéciaux',
...
clients grâce à la liste de vos meilleures ventes.',
  ...
  array (
    ...
    'The amounts include taxes, so you can get an estimation of the commission due to the payment method.' => 'Les montants sont avec taxes de sorte à ce que vous puissiez avoir une estimation de la commission due au service de paiement utilisé.',
...
d’inscriptions à votre newsletter.',
  ...
  array (
    ...
    'Contacting a group of clients by email or newsletter.' => 'Contactez des groupes de clients par courriel ou avec une liste de diffusion.',
  ...
  array (
    ...
    'Sales (tax excluded)' => 'Ventes (avant taxe)',
    'Total Viewed' => 'Total consulté',
    'Conversion rate' => 'Taux de transformation',
    'CSV Export' => 'Export CSV',
...
bancaires sur la page de paiement.',
  ...
  array (
    ...
    '1.62 in' => '1.62"',
    '15.5 g' => '15.5 g',
    '0.41 in (clip included)' => '0.41" (clip inclus)',
    '4.33 in' => '4.33"',
    '2.76 in' => '2.76"',
    '120g' => '120g',
    '0.31 in' => '0.31"',
  ...
  array (
    ...
    'You cannot use this voucher on products on sale' => 'Vous ne pouvez pas utilisé un bon de réduction pour un produit déjà en promo',
    ...
    'You cannot use this voucher in an empty cart' => 'Vous ne pouvez pas utilisé un bon de réduction dans un panier vide',
    ...
    'An error occurred while sending the email.' => 'Une erreur est survenue lors de l\'envoi du courriel.',
    ...
    'Login is required' => 'Connexion est nécessaire',
  ...
  array (
    ...
    'You have not received any credit slips.' => 'Vous n\'avez reçu aucune note de crédit.',
  ...
  array (
    ...
    'Product Total (Tax Excl.)' => 'Total Produits (avant taxe)',
    'Product Total (Tax Incl.)' => 'Total Produits (avec taxes)',
  ...
  array (
    ...
    'Taxes' => 'Taxes',
    'Total (tax incl.)' => 'Total (avec taxes)',
    'Total (tax excl.)' => 'Total (avant taxe)',
    '1 item' => '1 article',
    '%count% items' => '%count% articles',
    'A minimum shopping cart total of %amount% (tax excl.) is required to validate your order. Current cart total is %total% (tax excl.).' => 'Un montant total minimum de %amount% (HT) est requis pour valider votre commande. Le montant actuel de votre commande est de %total% (HT).',
  ...
  array (
    ...
    'When we receive your package, we will notify you by email. We will then begin processing order reimbursement.' => 'Dès réception de votre colis, nous procéderons au remboursement du montant de votre commande et vous en informerons par courriel.',
    ...
    'Credit slip' => 'Note de crédit',
    'View credit slip' => 'Afficher la note de crédit',
  ...
  array (
    ...
    'Get our latest news and special sales' => 'Recevez nos actualités et offres spéciales !',
  ...
  array (
    ...
    'The product(s) are matching one of these:' => 'Le(s) produit(s) correspondent à l\'un de ces critères :',
    'Discount name' => 'Nom de la réduction',
