    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                53 => ($this->targetDirs[3].'/modules/sendinblue/translations'),
                54 => ($this->targetDirs[3].'/modules/shipstation/translations'),
                55 => ($this->targetDirs[3].'/modules/ps_checkout/translations'),
                56 => ($this->targetDirs[3].'/modules/ps_newproducts/translations'),
                57 => ($this->targetDirs[3].'/modules/ps_specials/translations'),
                58 => ($this->targetDirs[3].'/modules/ps_bestsellers/translations'),
                59 => ($this->targetDirs[3].'/modules/ps_viewedproduct/translations'),
                60 => ($this->targetDirs[3].'/modules/tidiolivechat/translations'),
            ]; break;
